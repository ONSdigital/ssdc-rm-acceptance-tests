...
@step('a wave of contact has been created with template "{template}" and classifiers "{classifiers}"')
def create_a_wave_of_contact_with_template_and_classifers(context, template, classifiers):
